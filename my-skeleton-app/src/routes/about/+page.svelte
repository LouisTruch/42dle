...
<div class="container h-full mx-auto justify-center items-center">
	...
	<br />
	Made with
	<a href="https://kit.svelte.dev/" class="anchor">SvelteKit (Front-End)</a>,
	<a href="https://rocket.rs/" class="anchor">Rocket (Back-End)</a> and
	<a href="https://www.postgresql.org/" class="anchor">PostgreSQL</a>.
</div>
